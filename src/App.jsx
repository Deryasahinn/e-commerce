...
import { calculateBasket, setDrawer ,removeFromBasket,handleRemove } from './redux/slices/basketSlice'
...
function App() {
  ...
  const handleRemove = (id) => {
    ...
    dispatch(calculateBasket()); // Toplam tutarı güncelle
};
              ...
              return (
                <div key={product.id}>
                  <div className='flex-row' style={{ padding: '20px' }}>
                    ...
                    <button  onClick={() => handleRemove(product.id)}   style={{ padding: '5px', borderRadius: '5px', backgroundColor: ' rgb(53, 98, 162)', border: 'none', color: '#fff', width: '50px' }}>Sil</button>
                  </div>
